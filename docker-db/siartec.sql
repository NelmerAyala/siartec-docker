...
SELECT pg_catalog.setval('public.bank_account_id_seq', 6, false);
...
SELECT pg_catalog.setval('public.bank_id_seq', 34, false);
...
SELECT pg_catalog.setval('public.contributors_type_id_seq', 7, false);
...
SELECT pg_catalog.setval('public.entities_id_seq', 8, false);
...
SELECT pg_catalog.setval('public.point_of_sale_id_seq', 7, false);
...
SELECT pg_catalog.setval('public.subentity_id_seq', 34, false);
